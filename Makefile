...
$(DIST_WHEEL): $(PY_SOURCES) $(MO_FILES) $(SUBDIRS)
...
.PHONY: all install develop test doc source wheel zip tar dist clean tags release upload i18n $(SUBDIRS)
